...
export class AnalysesPageComponent implements OnInit {
  ...
  async onCreate() {
    ...
    try {
      ...
      for (const k of ['ph','mo_percent','cec_cmol','p_mgkg','k_cmol','ca_cmol','mg_cmol','s_mgkg','b_mgkg','fe_mgkg','mn_mgkg','zn_mgkg','cu_mgkg']) if (this.form[k] !== '' && this.form[k] !== null && this.form[k] !== undefined) payload[k] = Number(this.form[k]);
